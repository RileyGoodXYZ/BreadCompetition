...
| `backend/scripts/seed_demo_data.py` | Fill the db with real 2026arc data from TBA + Statbotics (needs `TBA_API_KEY` in `.env`; idempotent, `--reset` to reseed, `--refresh` to bypass the API cache) |
